...
public static ContractMilestone Create(Guid contractId,Guid proposalMilestoneId,string title,string description,decimal amount,int order,DateTime dueDate)
{
