...
namespace Kawadar.Infrastructure.Data.Migrations
{
    ...
    [Migration("20260218150531_updatingFreelancerBadgeEntity")]
    partial class updatingFreelancerBadgeEntity
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Kawadar.Domain.Badges.FreelancerBadges.FreelancerBadge", b =>
                {
                    ...
                    b.HasOne("Kawadar.Domain.UserProfiles.UserProfile", null)
                        .WithOne()
                        .HasForeignKey("Kawadar.Domain.Badges.FreelancerBadges.FreelancerBadge", "FreelancerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
